                            ...
                            <div class="cart-section wall-dimensions">
                                ...
                                <div class="customise-section">
                                    ...
                                    <div class="price-section">
                                        ...
                                        <span class="sq-price">{$formattedMeterPrice|escape:'htmlall':'UTF-8'} {$currencySign|escape:'html':'UTF-8'|htmlspecialchars_decode:3}/m2</span>
                                    </div>
                        ...
                        <div class="tab-content">
                            {foreach from=$getUnivers1 key=k item=universeImage}
                                <div class="tab-pane {if (1 == $k+1)}active{/if} docs-preview" id="scene{$k+1|escape:'htmlall':'UTF-8'}">
                                    <div class="backdrop" style="height:{if ($universeImage['universe_height'] > 0)}{$universeImage['universe_height']|escape:'htmlall':'UTF-8'}{else}76{/if}%;left:{$universeImage['universe_left']|escape:'htmlall':'UTF-8'}%;top:{$universeImage['universe_top']|escape:'htmlall':'UTF-8'}%;width:{if ($universeImage['universe_width'] > 0)}{$universeImage['universe_width']|escape:'htmlall':'UTF-8'}{else}100{/if}%;">
    ...
    <div class="boxDotted">
        <ul>
            {foreach from=$features item=feature}
                ...
                {/if}
            {/foreach}
            <li><span>{l s='Frais de ports offerts' mod='custommade'}</span><br/><span title="{l s='Uniquement en France mètropolitaine' mod='custommade'}">{l s='dès 150 € d\'achat' mod='custommade'}</span></li>
