			...
			{if !isset($customizedDatas.$productId.$productAttributeId) OR $quantityDisplayed > 0}
				...
				<div class="cart_quantity_border">
					...
					<div class="cart_quantity_button">
						...
						{else}
						<a class="cart_quantity_down" style="opacity: 0.3;" href="#" id="cart_quantity_down_{$product.id_product}_{$product.id_product_attribute}_0_{$product.id_address_delivery|intval}" title="{l s='You must purchase a minimum of %d of this product.' mod='custommade' sprintf=$product.minimal_quantity}"></a>
						{/if}
					</div>
				</div>
				{/strip}
